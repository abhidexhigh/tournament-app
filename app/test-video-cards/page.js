...
// Local video files from public/cardVideos folder
const localVideoCards = [
  ...
  "/cardVideos/Harpy Fire Loop.mp4",
  "/cardVideos/Harpy Light Loop.mp4",
  "/cardVideos/Harpy Loop Dark.mp4",
  ...
  "/cardVideos/Hydra Dark Loop.mp4",
  ...
  "/cardVideos/Samurai Dark Loop.mp4",
  "/cardVideos/Samurai Water loop.mp4",
