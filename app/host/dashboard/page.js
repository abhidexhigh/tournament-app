          ...
          <div className="border-gold-dark/20 bg-dark-gray-card/80 relative mb-8 overflow-hidden rounded-2xl border p-4 shadow-lg shadow-gray-800/30 backdrop-blur-sm sm:p-6 lg:px-8 lg:py-6">
            ...
            <div className="relative">
              ...
              <div className="sm:hidden">
                ...
                {/* Mobile: Game ID & Rank Grid */}
                <div className="mb-4 grid grid-cols-2 gap-2">
                  {/* Game ID Card */}
                  <div className="border-gold-dark/30 bg-dark-primary/60 rounded-xl border p-3">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <p className="text-[9px] font-medium tracking-wider text-white/50 uppercase">
                ...
                {/* Mobile: Quick Stats */}
                <div className="border-gold-dark/20 bg-dark-primary/40 mb-4 grid grid-cols-4 gap-1 rounded-xl border p-2">
                  <div className="flex flex-col items-center justify-center py-2">
                    <span className="text-gold-text text-lg font-bold">{stats.total}</span>
                    <span className="text-[8px] font-medium text-gray-500 uppercase">Total</span>
                  </div>
                  <div className="flex flex-col items-center justify-center border-l border-white/10 py-2">
                    <span className="text-gold text-lg font-bold">{stats.upcoming}</span>
                    <span className="text-[8px] font-medium text-gray-500 uppercase">{t("upcoming")}</span>
                  </div>
                  <div className="flex flex-col items-center justify-center border-l border-white/10 py-2">
                    <span className="text-emerald-400 text-lg font-bold">{stats.ongoing}</span>
                    <span className="text-[8px] font-medium text-gray-500 uppercase">{t("ongoing")}</span>
                  </div>
                  <div className="flex flex-col items-center justify-center border-l border-white/10 py-2">
                    <span className="text-blue-400 text-lg font-bold">{stats.completed}</span>
                    <span className="text-[8px] font-medium text-gray-500 uppercase">{t("completed")}</span>
                  </div>
                </div>

                {/* Mobile: Create Tournament Button */}
                <Link href="/host/create-tournament" className="block">
                  <Button
                    variant="primary"
                    size="md"
                    className="w-full"
